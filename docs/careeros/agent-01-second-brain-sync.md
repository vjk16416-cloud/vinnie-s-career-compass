...
- Native canonical Google Docs are authoritative when a canonical record also has a Markdown mirror.
- If a canonical Google Doc and its mirror conflict, the native Google Doc wins unless Vinnie explicitly approves a replacement.
- Update mirrors only after the canonical change has been confirmed.
...
The changing implementation checklist is maintained separately in the [Career OS Status & Readiness Checklist](https://docs.google.com/document/d/10Nv1gEdJtkXNYO_hCObRskdxMZgPJz0GfeH0vuTcpwY/edit).
